...
import generate  # Import your caption generation function
...
db = mysql.connector.connect(host="localhost", port=3308, user="root", password="", database="image_caption")
cur = db.cursor()
...
def users():
    ...
    db=mysql.connector.connect(host="localhost", port=3308, user="root", password="", db="image_caption")
